...
const { fetchDouyinVideoInfo: fetchDouyinData } = require("./services/douyinService");
const { fetchMetaData } = require("./services/facebookInstaService");
const { scrapeKuaishou: fetchKuaishouData } = require("./services/kuaishouService");
...
const { fetchTikTokData: fetchTiktokData } = require("./services/tiktokService");
